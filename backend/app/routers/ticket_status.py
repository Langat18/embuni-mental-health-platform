...
def assign_ticket(
    ...
    ticket.assigned_at = get_utc_now()
...
def reopen_ticket(
    ...
    if ticket.closed_at:
        ...
        if (get_utc_now() - closed_at_aware).days > 30:
            raise HTTPException(status_code=400, detail="Cannot reopen tickets closed for more than 30 days")
