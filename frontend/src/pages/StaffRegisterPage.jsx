          ...
          <div className="flex items-center justify-between">
            {[1, 2, 3].map((step) => (
              <React.Fragment key={step}>
                ...
                {step < 3 && (
                  <div className={`h-1 flex-1 mx-2 ${currentStep > step ? 'bg-green-600' : 'bg-gray-200'}`}></div>
                )}
              </React.Fragment>
            ))}
          </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <button type="button" onClick={handleNext} className="flex-1 bg-green-600 text-white py-3 rounded-lg font-semibold hover:bg-green-700 transition">
